...
%   Date:   01/12/2022                                                   %
%   Parse through WM.ROI file to create trace masks                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [mask,d,key] = wmROIs(filename)
% filename = 'C:\Users\griff\Downloads\segmentation\10042_1_03OZYDY8\WM14.roi';
...
for k = 1:trace-1
    ...
    f = cat(1,f,c);
    mask(:,:,k) = poly2mask(c(:,1),c(:,2),res,res);
    % imshow(mask(:,:,k));
end
